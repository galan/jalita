...
public class SessionManager implements Runnable {
	...
	/**
	 * Contains TerminalIOInterface-Objects which are interrupted, but are not
	 * closed
	 */
	...
	/**
	 * Closes the broken Session immediately. In difference to
	 * registerBrokenSession
	 * the IO of the Session will not be put in a Queue before closing, this
	 * happens here
	 * immediatly.
	 */
	...
	/**
	 * Placed a closed Session in the closed Session List, and removes it from
	 * the running Session List
	 */
