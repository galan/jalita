...
/**
 * Action describing Event, that is triggered by an user interaction on the
 * terminal.
...
public class TerminalEvent extends EventObject {
	...
	/**
	 * Creates an TerminalEvent object as key-representation (mostly for
	...
	/** Gibt bei druckbaren Zeichen dieses als String zur�ck */
