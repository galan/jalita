 ...
 * Added configuration setting to allow a maximum number of connections from the
 * same IP address
...
public class Configuration {
	...
	/**
	 * Here are the Defaultproperties, which will be used if the key is not
	 * present
	 * in the file. Additionally the defaultproperties will be created here if
	 * the
	 ...
	 * Attention: An existing file will be overriden (including formatting and
	 * usercomments)
	 */
	public void save() {
		try {
	 ...
	 * independent of an physically connection [ms]
	 */
