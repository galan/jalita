...
public class FormManager implements TerminalEventListener {
	...
	/**
	 * Draws all marked Widgets im Form neu, if <code>fullRedraw</code> all
	 * Widgets in any case
	 */
	...
	/**
	 * If IO has changed, the current Form from the current FormAutomationSet
	 * will be redrawn
	 */
	...
	/**
	 * Returns the TerminalIOInterface, which represents the connection to the
	 * terminal
	 */
	...
	/**
	 * Places a FormAutomationSet on the Stack, which will become the
	 * currentFormAutomationSet
	 */
	...
	/**
	 * Removes the current FormAutomationSet from the Stack and passes the
