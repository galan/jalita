 ...
 * Revision 1.5  2009/12/02 21:53:58  danielgalan
 * naming
 *
...
public class ListWidget extends BasicWidget {
	...
	/**
	 * Tells us if to the left and to the right the positioncursor should be
	 * shown
	 */
		...
		for (int i = 1; i <= getHeight(); i++) {
			if (((i + topIndex) >= 0) && (i + topIndex < (model.getSize()))) {
				...
				if (obj != null) {
					...
					// text beschneiden, falls zu lang f�r Liste
