...
public abstract class BasicForm implements TerminalEventListener {
	...
	/**
	 * All KeylabelListener. Key: TerminalEvent-Constant from the HotKeys /
	 * Object: KeyLabelWidget
	 */
	...
	/**
	 * Sets all widgets in the Form to dirty, so that all widgets will be
	 * repainted on next call of paint
	 */
	...
	public void paint() throws IOException {
		// bildschirm falls ben�tigt l�schen
		if (clearScreen) {
			clearScreen = false;
			getIO().clearScreen();
		}
