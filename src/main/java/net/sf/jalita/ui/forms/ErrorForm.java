 ...
 * Revision 1.3  2009/12/02 21:53:59  danielgalan
 * naming
 *
...
public class ErrorForm extends BasicForm {
	...
	/**
	 * Creates a new ErrorForm-Object, which executes exitAction from the owner
	 * on exit
	 */
	...
	/**
	 * Creates a new ErrorForm-Object, which switches to exitState from the
	 * owner on exit
	 */
	...
	/**
	 * Returns the Action, which will be executed when the ErrorForm will be
	 * closed
	 */
