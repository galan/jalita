 ...
 * Revision 1.6  2009/12/02 21:53:59  danielgalan
 * naming
 *
...
/**
 * This abstract class represents the parent for all classes, that define flows
 * for forms.
 * 
 * @author Daniel Galán y Martins
...
public abstract class FormAutomationSet {
	...
	/**
	 * This state lets the FormManager remove the current FormAutomationSet from
	 * the stack
	 */
	...
	/**
	 * This is the initial state, and should be set in initAutomationSet() with
	 * setInitState(int state)
	 */
	...
	/**
	 * Modifies the automaton state, and sets the registered Form with this
	 * state
	 * to the current.
	 */
	...
	/** Shows a DialogForm */
	public void showOptionForm(FormAutomationSet owner, String message, int okLabel, int abortLabel, int okAction, int abortAction) {
