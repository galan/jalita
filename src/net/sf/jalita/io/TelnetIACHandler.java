 ...
 * Last modified: $Date: 2009/02/26 16:45:33 $
 * 
 * $Log: TelnetIACHandler.java,v $
 * Revision 1.1  2009/02/26 16:45:33  ilgian
 * Added
 *
 *
 **********************************************************************/
...
/**
 * Telnet IAC handler: interprets tha IAC commands and responds
 * according to RFCs. 
 * The code is a refactoring of telnetd by Dieter Wimberger, so
 * thanks to his great work.
 *
 * @author  Gianluca Sartori
 * @version $Revision: 1.1 $
 */
public class TelnetIACHandler {

	protected byte[] buf;

	public TelnetIACHandler(InputStream in, OutputStream out) {
