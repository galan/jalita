...
public class NumberFieldWidget extends BasicWidget {
    ...
    public NumberFieldWidget(BasicForm owner, int posLine, int posColumn, int postionsBeforeDecimalPoint,
                             int positionsAfterDecimalPoint, boolean signAllowed, boolean cursorKeysEnabled,
                             int inputMethod, boolean clearBufferWhileNewInput) {
        this(owner, 0.0d, posLine, posColumn, postionsBeforeDecimalPoint, positionsAfterDecimalPoint, signAllowed,
             cursorKeysEnabled, inputMethod, clearBufferWhileNewInput);
        clearField();
    }
    ...
    /** Creates an ew NumberFieldWidget */
    public NumberFieldWidget(BasicForm owner, double number, int posLine, int posColumn,
                             int postionsBeforeDecimalPoint, int positionsAfterDecimalPoint,
                             boolean signAllowed, boolean cursorKeysEnabled,
                             int inputMethod, boolean clearBufferWhileNewInput) {
        super(owner, true);
