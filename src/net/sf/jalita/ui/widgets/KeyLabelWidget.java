...
/**
 * Inverted button, Action for this button should be processed global in the form
 *
 * @author  Daniel "tentacle" Galán y Martins
...
public class KeyLabelWidget extends LabelWidget {
    ...
    public KeyLabelWidget(BasicForm owner, String text, int key, int posLine, int posColumn, int width) {
        ...
        if ((key == TerminalEvent.KEY_F01) || (key == TerminalEvent.KEY_F02) ||
            (key == TerminalEvent.KEY_F03) || (key == TerminalEvent.KEY_F04) ||
            (key == TerminalEvent.KEY_F05) || (key == TerminalEvent.KEY_F06) ||
            (key == TerminalEvent.KEY_F07) || (key == TerminalEvent.KEY_F08) ||
            (key == TerminalEvent.KEY_F09) || (key == TerminalEvent.KEY_F10) ||
            (key == TerminalEvent.KEY_F11) || (key == TerminalEvent.KEY_F12) ||
            (key == TerminalEvent.KEY_ENTER)) {
