...
public class Session implements Runnable {
	...
	/**
	 * FormManager, which administrates an stack of FormAutomationSets and other
	 * elements
	 */
	...
	/**
	 * Binds a socket to this Session, create therewith a new TerminalIO and
	 * informs
	 * the FormManager. Furthermore an existing but eventually not closed
	 * Session,
	...
	public void bindSocket(Socket socket) {
		...
		try {
			/**
			 * TODO negotiate terminal type here later. maybe better in the
			 * Dispatcher transmitted thru via int consts?
			 */
	...
	/**
	 * Returns the current IO as String, or as "broken IO" if Connection is
	 * interrupted
	 */
	@Override
	...
	/**
	 * Shuts the Session down, informs the FormManager, which in turn informs
